...
export const Menu: React.FC<Props> = (props) => {
    ...
    if (menuType === 'bottomMenu') {
        return (
            <div className="menu">
                {links.map((link:any, index) => <div key={index} className="bottomNavBarItemBox"><NavLink exact activeClassName="btnProfileMenu"
                                                                                 key={link.id}
        ...
        return (
            <ul>
                {links.map((link:any, index) => <li key={index}><NavLink exact activeClassName="btnProfileMenu" key={link.id}
